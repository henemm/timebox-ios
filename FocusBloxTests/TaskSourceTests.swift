...
final class TaskSourceTests: XCTestCase {
    ...
    func test_taskSource_fetchIncompleteTasks_returnsOnlyIncomplete() async throws {
        let source = MockTaskSource()
        source.tasks = [
            MockTaskData(id: "1", title: "Task 1", isCompleted: false, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock"),
            MockTaskData(id: "2", title: "Task 2", isCompleted: true, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock"),
            MockTaskData(id: "3", title: "Task 3", isCompleted: false, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock")
        ]
    ...
    func test_taskSource_markIncomplete_updatesTask() async throws {
        let source = MockTaskSource()
        source.tasks = [
            MockTaskData(id: "1", title: "Task 1", isCompleted: true, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock")
        ]
    ...
    func test_taskSourceWritable_createTask_addsNewTask() async throws {
        ...
        XCTAssertEqual(newTask.importance, 1)
    ...
    func test_taskSourceWritable_updateTask_modifiesExistingTask() async throws {
        let source = MockTaskSource()
        source.tasks = [
            MockTaskData(id: "1", title: "Old Title", isCompleted: false, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock")
        ]

        try await source.updateTask(taskID: "1", title: "New Title", tags: ["Work"], dueDate: nil, importance: 2, estimatedDuration: nil, urgency: "urgent", taskType: "income", recurrencePattern: "weekly", recurrenceWeekdays: [1, 3], recurrenceMonthDay: nil, description: "Updated")

        XCTAssertEqual(source.tasks[0].title, "New Title")
        XCTAssertEqual(source.tasks[0].tags, ["Work"])
        XCTAssertEqual(source.tasks[0].importance, 2)
    ...
    func test_taskSourceWritable_deleteTask_removesTask() async throws {
        ...
        source.tasks = [
            MockTaskData(id: "1", title: "Task 1", isCompleted: false, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock"),
            MockTaskData(id: "2", title: "Task 2", isCompleted: false, importance: 1, tags: [], dueDate: nil, urgency: nil, taskType: "maintenance", recurrencePattern: "none", recurrenceWeekdays: nil, recurrenceMonthDay: nil, taskDescription: nil, externalID: nil, sourceSystem: "mock")
        ]
