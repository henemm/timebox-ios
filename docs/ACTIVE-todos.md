...
| CHORE_001 | Aufräumen: .gitignore + uncommitted Workflow-/Doku-Dateien | Low | S | Beide | Alle uncommitted Änderungen aus vorherigen Sessions sauber committen. .gitignore um temporäre State-Dateien erweitert. |
