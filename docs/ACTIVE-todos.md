...
| ~~RW_3.1a~~ | ~~3 Ausfuehrung~~ | ~~Calendar Task Drop — Phase A: Model Layer~~ | ~~Medium~~ | ~~S~~ | ~~Shared~~ | ~~[Spec](specs/rework/3.1a-calendar-task-drop-model-layer.md)~~ ERLEDIGT |
| RW_3.1b | 3 Ausfuehrung | Calendar Task Drop — Phase B: iOS Schedule/Unschedule Logic | Medium | S | Shared | [Spec](specs/rework/3.1-calendar-task-drop.md) |
| RW_3.1c | 3 Ausfuehrung | Calendar Task Drop — Phase C: ScheduledTaskBlock + Context Menu | Medium | S | Eigene View | [Spec](specs/rework/3.1-calendar-task-drop.md) |
