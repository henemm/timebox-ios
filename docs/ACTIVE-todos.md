...
| ~~BUG_111~~ | ~~macOS UI Tests: "Enable UI Automation"-Dialog erscheint bei jedem Testlauf~~ | ~~High~~ | ~~S~~ | ~~macOS~~ | ~~TCC-Dialog blockierte macOS UI Tests via SSH. Fix: automationmodetool für TCC-Autorisierung. Analyse: `docs/artifacts/bug-111-macos-ui-test-dialog/analysis.md`~~ ERLEDIGT |
