...
final class EisenhowerMatrixTests: XCTestCase {
    ...
    func test_doFirstQuadrant_filtersUrgentAndHighPriority() async throws {
        ...
        let doFirstTasks = planItems.filter { $0.urgency == "urgent" && $0.priority == 3 && !$0.isCompleted }
    ...
    func test_scheduleQuadrant_filtersNotUrgentAndHighPriority() async throws {
        ...
        let planItems = try await syncEngine.sync()
        let scheduleTasks = planItems.filter { $0.urgency == "not_urgent" && $0.priority == 3 && !$0.isCompleted }
    ...
    func test_delegateQuadrant_filtersUrgentAndLowerPriority() async throws {
        ...
        let planItems = try await syncEngine.sync()
        let delegateTasks = planItems.filter { $0.urgency == "urgent" && $0.priority < 3 && !$0.isCompleted }
    ...
    func test_eliminateQuadrant_filtersNotUrgentAndLowerPriority() async throws {
        ...
        let planItems = try await syncEngine.sync()
        let eliminateTasks = planItems.filter { $0.urgency == "not_urgent" && $0.priority < 3 && !$0.isCompleted }
    ...
    func test_allQuadrants_distributeTasksCorrectly() async throws {
        ...
        let q1 = planItems.filter { $0.urgency == "urgent" && $0.priority == 3 && !$0.isCompleted }
        let q2 = planItems.filter { $0.urgency == "not_urgent" && $0.priority == 3 && !$0.isCompleted }
        let q3 = planItems.filter { $0.urgency == "urgent" && $0.priority < 3 && !$0.isCompleted }
        let q4 = planItems.filter { $0.urgency == "not_urgent" && $0.priority < 3 && !$0.isCompleted }
